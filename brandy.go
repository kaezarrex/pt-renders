...
func main() {
	...
	scene.Add(pt.NewCube(pt.Vector{-1000, -1, -100}, pt.Vector{100, -0.6, 100}, pt.DiffuseMaterial(pt.Color{1, 1, 1})))
	camera := pt.LookAt(pt.Vector{0, 1, -3}, pt.Vector{0, 0, 0}, pt.Vector{0, 1, 0}, 45)
	pt.IterativeRender("renders/brandy%03d.png", 1000, &scene, &camera, 512, 512, -1, 16, 8)
}
